...
function CreateCommunity({ closePopUp }) {
  ...
  const handle_create = async (e) => {
    ...
    const admin_id = JSON.parse(window.localStorage.getItem("currentUser")).student_id;
    ...
    const response = await axios.post("http://localhost:3002/insertCommunity", requestBody).catch(error => {
    ...
    >
      ...
      <form className="create-com-form" onSubmit={handle_create}>
        <div className="privacy-holder">
          <div className="privacy-header">Select a privacy type for your community</div>
          <div className="privacy-radio">
            <div>
              ...
              />
              <label htmlFor="private" className="radio-text">Private</label>
            </div>
            <div>
              <input
                ...
                onChange={(e) => { setPrivacy(e.target.value) }}
              />
              <label htmlFor="open" className="radio-text">Open</label>
            </div>
          </div>
        </div>
        ...
        <div className="create-fields">
          <div className='create-field-2'>
            <label htmlFor="name" className="filed-label">Name*</label>
            <input
              required
              id='name'
              type="text"
          ...
          <div className='create-field-2'>
            <label htmlFor="tag" className="filed-label">Tag*</label>
            <input
              required
              id='tag'
              type="text"
          ...
          <div className='create-field-2'>
            <label htmlFor="desc" className="filed-label">Description*</label>
            <textarea
              spellCheck
              required
              id='desc'
