...
import { BsChatDots as ChatIcon, BsStack as ResourceIcon } from "react-icons/bs";
            ...
            <div className="com-menu-icon">
               {expandMenu ? (
                  <div className="com-menu-item">
                     ...
                     <div
                        title="Dashoard"
                        onClick={() => { active_and_navigate("dashboard", `/profile/com-holder/${urlTag}/dashboard`) }}
                        className={
                           comActiveMenu === "dashboard" ? "com-menu-item-icon-active" :
                              "com-menu-item-icon"}
                     >
                        <DashboardIcon />
                     </div>
                     <div
                        title="Chat"
                        onClick={() => { active_and_navigate("chat", `/profile/com-holder/${urlTag}/chat`) }}
                        className={
                           comActiveMenu === "chat" ? "com-menu-item-icon-active" :
                              "com-menu-item-icon"}
                     >
                        <ChatIcon />
                     </div>
