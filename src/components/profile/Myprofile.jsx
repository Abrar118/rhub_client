...
import {
  BsCloudUploadFill as Upload,
  BsInfoCircle as Info,
  BsBookmarkStar as Bookmark,
} from "react-icons/bs";
import {
  BiSolidMessageCheck as Inbox,
    ...
    return (
      <div className="menu-wrapper">
        ...
        <MenuItem
          MenuIcon={Bookmark}
          menutext={"Bookmarks"}
          linkTo={"/profile/bookmark"}
        />
        <MenuItem
          MenuIcon={MyCommunities}
          menutext={"My Communities"}
          linkTo={"/profile/my-commnunities"}
        />
        <MenuItem
          MenuIcon={Upload}
          menutext={"My Uploads"}
          linkTo={"/profile/my-uploads"}
        />
        <MenuItem
          MenuIcon={Notification}
          menutext={"Notifications"}
          linkTo={"/profile/notification"}
        />
        <MenuItem
          MenuIcon={Inbox}
          menutext={"Inbox"}
          linkTo={"/profile/inbox"}
        />
        <MenuItem
          MenuIcon={Help}
          menutext={"Help and Privacy Policy"}
          linkTo={"/profile/help"}
        />
      </div>
    );
